...
llm = ChatGoogleGenerativeAI(model="gemini-1.5-pro", temperature=0, request_timeout=240)

template = """ Você é um assistente de uma academia chamada SmartFit e tem como objetivo responder \
...
chain_faq = prompt_template | llm | StrOutputParser()